...
theme.set_highlights = function()
  ...
  hl(0, "CursorLineNr", { fg = c.gray_light, bg = 'NONE', bold=true, })
  ...
  hl(0, "FloatBorder", { fg = c.fg, bg = c.dark })
  ...
  hl(0, "VisualNOS", { fg = 'NONE', bg = c.bg })
  ...
  hl(0, "TSRepeat", { fg = c.gray_light, bg = 'NONE' })
