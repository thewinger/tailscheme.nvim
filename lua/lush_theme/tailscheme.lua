...
local cursor_fg = hsl(210, 40, 98)
local cursor_bg = hsl(222, 47, 11)
local sign_add = hsl(160, 84, 39)
local sign_change = hsl(217, 91, 60)
local sign_delete = hsl(351, 95, 71)
local tree_sign_add = hsl(142, 71, 45)
local tree_sign_change = hsl(31, 97, 72)
local error_red = hsl(351, 95, 71)
local warning_orange = hsl(31, 97, 72)
local info_yellow = hsl(50, 98, 64)
local hint_blue = hsl(199, 89, 48)
local success_green = hsl(160, 84, 39)
...
local theme = lush(function(injected_functions)
    ...
    NotifyDEBUGBorder 	       { gray },
    NotifyDEBUGIcon 	         { gray },
    NotifyDEBUGTitle  	       { gray },
    NotifyTRACEBorder 	       { purple },
    NotifyTRACEIcon 	         { purple },
    NotifyTRACETitle  	       { purple },
    NotifyINFOBorder 	         { blue },
    NotifyINFOIcon 	           { blue },
    NotifyINFOTitle 	         { blue },
    ...
    NotifyBackground 	         { bg = dark },
      ...
      -- [Noice]
    NoiceCmdlinePopupTitle 	   { magenta },
    NoiceCmdlinePopupBorder 	 { white },
    NoiceCmdlineIcon 	         { magenta },
